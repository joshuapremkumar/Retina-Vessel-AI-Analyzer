...
## 🚀 Overview
A diagnostic support tool developed for [Hackathon Name]. It automates the calculation of **CRAE** and **CRVE** metrics from fundus images to predict risks of Hypertension, Stroke, and Ischemia.
